...
export const Home = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput onChangeText={setNewTask} placeholderTextColor='#555' placeholder="Tarefas" style={styles.fields} value={newTask} />
